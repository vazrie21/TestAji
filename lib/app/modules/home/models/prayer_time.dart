// ignore_for_file: unnecessary_this, prefer_interpolation_to_compose_strings, non_constant_identifier_names
...
class PrayerTime {
  // ---------------------- Global Variables --------------------
  int _calcMethod = 0; // caculation method
  int _asrJuristic = 0; // Juristic method for Asr
  int _dhuhrMinutes = 0; // minutes after mid-day for Dhuhr
  int _adjustHighLats = 0; // adjusting method for higher latitudes
  ...
  // ------------------------------------------------------------
  // Calculation Methods
  int _jafri = 0; // Ithna Ashari
  int _karachi = 0; // University of Islamic Sciences, Karachi
  int _iSNA = 0; // Islamic Society of North America (ISNA)
  int _mWL = 0; // Muslim World League (MWL)
  int _makkah = 0; // Umm al-Qura, Makkah
  int _egypt = 0; // Egyptian General Authority of Survey
  int _custom = 0; // Custom Setting
  int _tehran = 0; // Institute of Geophysics, University of Tehran

  // Juristic Methods
  int _shaffi = 0; // Shafii (standard)
  int _hanafi = 0; // Hanafi

  // Adjusting Methods for Higher Latitudes
  int _none = 0; // No adjustment
  int _midNight = 0; // middle of night
  int _oneSeventh = 0; // 1/7th of night
  int _angleBased = 0; // angle/60th of night

  // Time Formats
  int _time24 = 0; // 24-hour format
  int _time12 = 0; // 12-hour format
  int _time12Ns = 0; // 12-hour format with no suffix
  int _floating = 0; // floating point number

  // Time Names
  List<String> _timeNames = List<String>.empty().obs;
  ...
  List<double> _prayerTimesCurrent = List.empty();
  List<int> _offsets = List.empty();
  ...
  PrayerTime() {
    ...
    _offsets = new List<int>.filled(7, 0, growable: true);
    _offsets[0] = 0;
    _offsets[1] = 0;
    _offsets[2] = 0;
    _offsets[3] = 0;
...
/*   getTimeZone1() {
  ...
  List<double> sunPosition(double jd) {
    ...
    List<double> sPosition = List.filled(2, 0, growable: true);
    sPosition[0] = d;
    sPosition[1] = EqT;
